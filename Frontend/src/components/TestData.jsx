...
function TestData() {
  ...
  useEffect(() => {
    const fetchLogs = async () => {
      try {
        const response = await axios.get("/api/test/testlogs");
  ...
  const columns = [
    ...
    },
    {
      ...
      width: 200,
      renderHeader: () => (
        <div className="text-base font-poppins font-semibold">File Name</div>
      ),
    },
    {
      field: "genuine_count",
    ...
    },
    {
      ...
      width: 200,
      renderHeader: () => (
        <div className="text-base font-poppins font-semibold">Timestamp</div>
      ),
      renderCell: (params) => {
        ...
        <div className="flex flex-col items-center justify-center ">
          <div className=" mt-10 ">
            ...
            <p className="text-red-500 text-center">
              Note: The Excel file must contain less than 25,000 rows of data
              for testing.
            </p>
            <form
              ...
              <div className="fixed inset-0 bg-gray-900 bg-opacity-50 flex justify-center items-center z-50">
                <div className="bg-white rounded-lg shadow-lg w-3/4 md:w-1/2 p-8">
                  ...
                  <div className="mt-6 flex justify-end space-x-4">
                    ...
                    <Link
                      className="bg-blue-400 text-white font-semibold py-2 px-4 rounded hover:bg-blue-600transition duration-200"
                      to="/admin/import"
                    >
                      Import
                    </Link>
          ...
          <div className="mt-10 mb-12" style={{ height: "50vh", width: "60%" }}>
